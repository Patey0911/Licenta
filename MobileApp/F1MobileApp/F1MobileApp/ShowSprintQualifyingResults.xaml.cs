...
namespace F1MobileApp
{
    ...
    public partial class ShowSprintQualifyingResults : ContentPage
    {
        List<DriverModel> DriversSortedList;
        public string circuitname;
        public ShowSprintQualifyingResults(string circuit)
        {
            InitializeComponent();
            circuitname = circuit;
        }
        ...
        private async Task ShowDrivers()
        {
            ...
            RaceName.Text = Results.CircuitName.ToUpper() + " Shootout";

            //1st Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying1);
            ...
            //2nd Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying2);
            ...
            //3rd Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying3);
            ...
            //4th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying4);
            ...
            //5th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying5);
            ...
            //6th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying6);
            ...
            //7th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying7);
            ...
            //8th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying8);
            ...
            //9th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying9);
            ...
            //10th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying10);
            ...
            //11th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying11);
            ...
            //12th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying12);
            ...
            //13th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying13);
            ...
            //14th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying14);
            ...
            //15th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying15);
            ...
            //16th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying16);
            ...
            //17th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying17);
            ...
            //18th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying18);
            ...
            //19th Place
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying19);
            ...
            Driver = await DriverRepository.GetByNo(Results.SprintQualifying20);
