...
namespace F1MobileApp
{
    ...
    public partial class ShowResults : ContentPage
    {
        List<DriverModel> DriversSortedList;
        public string circuitname;
        public ShowResults(string circuit)
        {
            InitializeComponent();
            circuitname = circuit;
        }
        ...
        private async Task ShowDrivers()
        {
            ...
            RaceName.Text = Results.CircuitName.ToUpper() + " Race";

            //1st Place
            Driver = await DriverRepository.GetByNo(Results.Place1);
            ...
            //2nd Place
            Driver = await DriverRepository.GetByNo(Results.Place2);
            ...
            //3rd Place
            Driver = await DriverRepository.GetByNo(Results.Place3);
            ...
            //4th Place
            Driver = await DriverRepository.GetByNo(Results.Place4);
            ...
            //5th Place
            Driver = await DriverRepository.GetByNo(Results.Place5);
            ...
            //6th Place
            Driver = await DriverRepository.GetByNo(Results.Place6);
            ...
            //7th Place
            Driver = await DriverRepository.GetByNo(Results.Place7);
            ...
            //8th Place
            Driver = await DriverRepository.GetByNo(Results.Place8);
            ...
            //9th Place
            Driver = await DriverRepository.GetByNo(Results.Place9);
            ...
            //10th Place
            Driver = await DriverRepository.GetByNo(Results.Place10);
            ...
            //11th Place
            Driver = await DriverRepository.GetByNo(Results.Place11);
            ...
            //12th Place
            Driver = await DriverRepository.GetByNo(Results.Place12);
            ...
            //13th Place
            Driver = await DriverRepository.GetByNo(Results.Place13);
            ...
            //14th Place
            Driver = await DriverRepository.GetByNo(Results.Place14);
            ...
            //15th Place
            Driver = await DriverRepository.GetByNo(Results.Place15);
            ...
            //16th Place
            Driver = await DriverRepository.GetByNo(Results.Place16);
            ...
            //17th Place
            Driver = await DriverRepository.GetByNo(Results.Place17);
            ...
            //18th Place
            Driver = await DriverRepository.GetByNo(Results.Place18);
            ...
            //19th Place
            Driver = await DriverRepository.GetByNo(Results.Place19);
            ...
            //20th Place
            Driver = await DriverRepository.GetByNo(Results.Place20);
