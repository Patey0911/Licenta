...
namespace F1MobileApp
{
    ...
    public partial class ShowSprintResults : ContentPage
    {
        List<DriverModel> DriversSortedList;
        public string circuitname;
        public ShowSprintResults(string circuit)
        {
            InitializeComponent();
            circuitname = circuit;
        }
        ...
        private async Task ShowDrivers()
        {
            ...
            RaceName.Text = Results.CircuitName.ToUpper() + " Sprint";

            //1st Place
            Driver = await DriverRepository.GetByNo(Results.Sprint1);
            ...
            //2nd Place
            Driver = await DriverRepository.GetByNo(Results.Sprint2);
            ...
            //3rd Place
            Driver = await DriverRepository.GetByNo(Results.Sprint3);
            ...
            //4th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint4);
            ...
            //5th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint5);
            ...
            //6th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint6);
            ...
            //7th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint7);
            ...
            //8th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint8);
            ...
            //9th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint9);
            ...
            //10th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint10);
            ...
            //11th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint11);
            ...
            //12th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint12);
            ...
            //13th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint13);
            ...
            //14th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint14);
            ...
            //15th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint15);
            ...
            //16th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint16);
            ...
            //17th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint17);
            ...
            //18th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint18);
            ...
            //19th Place
            Driver = await DriverRepository.GetByNo(Results.Sprint19);
            ...
            //20th Place
            if (Results.Sprint20 != null)
            {
                Driver = await DriverRepository.GetByNo(Results.Sprint20);
